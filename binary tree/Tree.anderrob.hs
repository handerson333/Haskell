module Tree where
        ...
        maxInt :: Tree -> Int
        maxInt (Leaf x) = x
        maxInt (Node x l r) = maximum [(maxInt l), (maxInt r), x]
        ...
        minInt :: Tree -> Int
        minInt (Leaf x) = x
        minInt (Node x l r) = minimum [(minInt l), (minInt r), x]
        ...
        sumInts :: Tree -> Int
        sumInts (Leaf x) = x
        sumInts (Node x l r) = sum [( sumInts l), (sumInts r), x]
        ...
        --   False
        --
        --   https://stackoverflow.com/questions/48371006/checking-if-an-int-is-in-a-bst-haskell
        inBST :: Int -> Tree -> Bool
        inBST n (Leaf x) = n == x
        inBST n (Node x l r) = any (== n) ( inorder (Node x l r))
